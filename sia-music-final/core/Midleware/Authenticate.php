...
class AuthenticateUtils extends Core
 {
    ...
    /**
     * session ID Checking; functionality; forces SessionID Checking and Generation
     */
    ...
    /** returning current session if it exists
     */
