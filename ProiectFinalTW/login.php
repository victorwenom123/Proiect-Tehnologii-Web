...
<body>
    <div class="hero">
        <div class="navbar">
            ...
            <div>
                <button class="btn-2" onclick="window.location.href='index.php'"><strong>Back to home</strong></button>
                <button class="btn-2" onclick="window.location.href='socialmedia.php'"><strong>socialmedia-demo</strong></button>
            </div>
        </div>
