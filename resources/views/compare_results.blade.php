            ...
            <div class="formbox1" style="text-align:center; margin:auto;color:white;">
                <h2>Compare results</h2>
                   ...
                   @if($results)
                        ...
                        <b>Song Similarity</b>:{{$results["artist_similarity"]}} <br/>
                        <b>Tag similarity</b>: {{$results["tags_similarity"]}} <br/>
                        <b>Comment similarity</b>: {{$results["comment_similarity"]}} <br/>
                        <b>Genre similarity</b>: {{$results["genre_similarity"]}} <br/>
                        <b>Length/Playtime similarity</b>: {{$results["length_similarity"]}} <br/>
