...
<div class="hero">
    ...
    <div class="content">
        ...
        <button type="button" class="btn-2" onclick="window.location.href='report'"><strong>Scholarly HTML Report!</strong></button>
        <button type="button" class="btn-2" onclick="window.location.href='guide'"><strong>User Guide</strong></button>
    </div>
    <div class="sounds">
