...
<section id="implementare">
    ...
    <p>În ceea ce privește interacțiunea aplicație-utilizator, pe pagina Home, utilizatorul beneficiază de următoarele opțiuni: poate accesa "Compare songs" ( <a href="https://imgur.com/9PMyNvO">screenshot</a> ) pentru a completa un formular, ce
        îl va direcționa spre o pagină care va afișa rezultatul comparației ( <a href="https://imgur.com/RW3NfDu">screenshot</a> ) . Acest formular conține date precum: numele, autorul, durata, tag-urile, genul, cât și comentariile melodiilor
        .
    </p>
    <p>Analog, poate accesa "Get recommandations" ( <a href="https://imgur.com/e4IV9uO">screenshot</a> ), pentru a primi anumite recomandări pe o nouă pagină ( <a href="https://imgur.com/YlelJdy">screenshot</a> ) . Va completa un formular conținând
    ...
    <p>Rețeaua socială ( <a href="https://imgur.com/meSrbql">screenshot</a> ) va afișa recomandări de melodii, dar va oferi și posibilitatea utilizatorului de a comunica cu alți utilizatori prin intermediul tweet-urilor. De asemenea, aceasta pune
        la dispoziție un buton de "Back" pentru a reveni la pagina anterioară.</p>
